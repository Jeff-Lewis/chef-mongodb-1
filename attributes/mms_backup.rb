...
default[:mongodb][:mms_backup][:version] = "2.4.0.156"
default[:mongodb][:mms_backup][:install_url] = "https://mms.mongodb.com/download/agent/backup/mongodb-mms-backup-agent_#{node[:mongodb][:mms_backup][:version]}-1_amd64.deb"
